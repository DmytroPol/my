...
//
//					case "2": //РЕГИСТРАЦИЯ
//						System.out.println("Registration form, please create your login and password:");
...
try{
            ...
            if ( resp != 200) {
    //         System.out.println("Registration failed ( err "+resp+" )");// вывод на экран при отсутствии регистрации
               scanner.close();
            }
            else
            {
